from Ningsih import bot as app
...
Ningsih supports a large number of formatting 
...
the user will be redirected to Ningsih's PM to see the note."""
...
This will randomly choose between sending the first message, "hello", or the second message, "how are you".
 Use this to make Ningsih feel a bit more customised! (only works in notes/filters/greetings)
