...
from Ningsih.mongo.flooddb import is_flood_on,flood_off,flood_on
from Ningsih.utils.filter_groups import flood_group
...
Anti-Function is the inbuilt toolkit in Ningsih for avoid spammers, and to improve Anti-Function of your group"""
__helpbtns__ = (
        [[
            InlineKeyboardButton
                (
