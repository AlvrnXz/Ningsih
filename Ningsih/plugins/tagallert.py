...
from Ningsih.mongo import taggeddb
from button import Tagalert
from Ningsih.utils.filter_groups import tagallert
...
async def mentioned_alert(client, message):   
    try:
        ...
        if "@" in input_str:
            ...
            Ningsih = input_str.split("|")[1]
            text = Ningsih.split()[0]
...
If you are tagged/mentioned in a group where Ningsih is present
Ningsih will notify it to you via private message after enabling tag alerts
...
**Example:**
If you are mentioned in a group Ningsih will tell you who mentioned you, 
