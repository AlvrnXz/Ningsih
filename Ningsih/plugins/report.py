...
from Ningsih.mongo.reportdb import Reporting
...
Ningsih will then reply with a message stating that admins have been notified. 
...
or when used to report an admin. Ningsih assumes that admins 
