...
IMG = "https://graph.org/file/110a4924ce941c92af387.jpg"
...
async def wishper_ai(_, sz: InlineQuery):
    ...
    if query == '' or len(query) > lengths \
        ...
        content = ("**Send whisper messages through inline mode**\n\n"
                   "Usage: `@ningsihxrobot [@username] text`")
        description = "Usage: @ningsihxrobot [@username] text"
        button = InlineKeyboardButton(
            "More-Help",
            url="https://t.me/ningsihxrobot?start=learn"
        )
...
@ningsihxrobot your whisper @username
...
example:- 
@ningsihxrobot hello this is a test @pvgzt
