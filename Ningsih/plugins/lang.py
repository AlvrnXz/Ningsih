...
from Ningsih.mongo.language import set_lang,get_lang
...
__HELP__ = """
Not every group speaks fluent english; some groups would rather have Ningsih respond in their own language.
