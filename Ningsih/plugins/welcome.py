...
from Ningsih import app,BOT_ID,OWNER_ID,LOG_GROUP_ID
from Ningsih.mongo.gban import GBan
from Ningsih.mongo.usersdb import adds_served_user
from Ningsih.mongo.welcomedb import Greetings
from Ningsih.utils.custom_filters import admin_filter, command
...
from Ningsih.utils.filter_groups import cleanner,welcomes,leftwelcome
...
my news channel @spotifyindonesian.

**New to Me, Touch the below button and start me in PM**
                    """,
                    reply_markup=InlineKeyboardMarkup(
            [
                InlineKeyboardButton("quick start guide", url="http://t.me/ningsihxrobot?start=help"),
            ]))
        ...
        if member.id == 1865232417:#for @pvgzt 
            return await app.send_message(
                message.chat.id,
                "Wow ! Developer baru saja bergabung dengan obrolan Grup Anda.",
            )       
        if member.is_bot:
