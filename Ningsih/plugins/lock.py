...
from Ningsih.mongo.locksdb import (
    b_on,
    b_off,
    is_b_on,
    remove_chat,
)
from Ningsih import app, app as pbot, MONGO_URL as  MONGO_DB_URI,LOG_GROUP_ID
from Ningsih.utils.custom_filters import admin_filter
from button import Locks
from Ningsih.core.decorators.permissions import current_chat_permissions,member_permissions


#====== Mongo database =========
client = pymongo.MongoClient(MONGO_DB_URI)
dbd = client["ningsihxrobot"]
db = dbd
lockdb = db.lockdb1
#================================
