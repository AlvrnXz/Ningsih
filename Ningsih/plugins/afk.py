...
from Ningsih.utils.filter_groups import afkcheacker
from Ningsih.mongo.afkdb import is_afk, add_afk, remove_afk, get_afk_users
...
@app.on_message(filters.command(["afk", f"afk@ningsihxrobot"]))
