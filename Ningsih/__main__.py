...
from Ningsih.utils.lang import *
...
from Ningsih.plugins import ALL_MODULES
from Ningsih.utils import paginate_modules
from lang import get_command
from Ningsih.utils.lang import (
    language,
    languageCB
)
from Ningsih.utils.start import (
    get_private_rules,
    get_learn
)
from Ningsih.mongo.usersdb import (
    adds_served_user,
    add_served_user
)
from config import var
from Ningsih.mongo.chatsdb import add_served_chat
...
async def start_bot():
    ...
    for module in ALL_MODULES:
        imported_module = importlib.import_module("Ningsih.plugins." + module)
        if (
